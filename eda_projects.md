...
### [Final Project: Equivalent Latitude - Comparison of two PV-based calculations and comparison of two reanalysis products (preliminary results)](portfolio_post/01_eqlat_reanalysis_comparison_jesswein.html)

*These are the preliminary, mid-project results. See the [final write-up](final_project.html) for the completed project, including the full comparison against NOAA AirCore and ozonesonde observations.*
